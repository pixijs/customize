...
export class Customize extends Component<any, State> {
    constructor() {
        ...
        state.htmlResult = createHTMLCode(state.packages);
        this.state = state;
    }
    ...
    private refreshPackages(packages:string[]) {
        ...
        this.setState({
            ...
            htmlResult: createHTMLCode(packages)
        });
    }
    ...
    render(props:any, { packages, useYarn, useBundler, bundleCode, htmlResult }:State) {
