...
export class Customize extends Component<any, State> {
    constructor() {
        ...
        const state:State = {
            ...
            unminifed: !!localStorage.getItem(UNMINIFED),
        };
        ...
        state.htmlResult = createHTMLCode(state.packages, state.unminifed);
        this.state = state;
    }
    ...
    /**
     * Toggling unminifed checkbox
     */
    @bind
    private onUnminified(event:Event) {
        const {checked} = event.currentTarget as HTMLInputElement;
        if (checked) {
            localStorage.setItem(UNMINIFED, '1');
        }
        else {
            localStorage.removeItem(UNMINIFED);
        }
        this.setState({
            unminifed: checked, 
            htmlResult: createHTMLCode(this.state.packages, checked)
        });
    }
    ...
    private refreshPackages(packages:string[]) {
        ...
        this.setState({
            ...
            htmlResult: createHTMLCode(packages, this.state.unminifed)
        });
    }
    ...
    render(props:any, { packages, useYarn, useBundler, bundleCode, htmlResult, unminifed }:State) {
        return (<div class="app-container">
            ...
            <div class="app-main">
                ...
                { useBundler && <div class="app-col app-col-bundler">
                    ...
                    <p>This is usefull because since some of Pixi's plugins are enabled
                    with the renderer, app and/or loaders,
                    they can't get automatically tree-shaken away by module bundlersshaked.</p>
                ...
                { !useBundler && <div class="app-col app-col-browser">
                    <h2>
                        <div class="custom-control custom-checkbox float-right">
                            ...
                            class="custom-control-input"
                            id="unminified"
                            onChange={this.onUnminified}
                            checked={unminifed} />
                            <label class="custom-control-label small text-muted" for="unminified"><small>Development</small></label>
                        </div>
                        Browser Code
                    </h2>
